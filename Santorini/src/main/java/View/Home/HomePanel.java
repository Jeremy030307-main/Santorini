...
public class HomePanel extends SantoriniPanel {
    ...
    private void createPlayButton(){
        ...
        ImageIcon icon = new ImageIcon(Objects.requireNonNull(this.getClass().getResource("/Image/Button/play_button.png")));
    ...
    private void createLoadButton(){
        ...
        ImageIcon icon = new ImageIcon(Objects.requireNonNull(getClass().getResource("/Image/Button/load_button.png")));
        Image img = icon.getImage().getScaledInstance((int) (getMaxWidth()*0.2),(int) (getMaxWidth()*0.2) , Image.SCALE_SMOOTH);
        icon = new ImageIcon(img);
