...
public abstract class SetupPanel extends SantoriniPanel {
    ...
    private void add_active_player_label(){
        ...
        ImageIcon bgIcon = new ImageIcon(Objects.requireNonNull(getClass().getResource("/Image/Label/message.png")));
...
//        activePlayerTextLabel.setFont(new Font("Comic Sans MS", Font.BOLD, (int) (scaledIcon.getIconHeight()*0.25)));
    ...
    private void add_choose_gods_text(String imgPath) {
        ImageIcon logoIcon = new ImageIcon(Objects.requireNonNull(getClass().getResource("/Image/Text/" + imgPath)));
    ...
    private void createButton(String leftButtonImgPath, String rightButtonImgPath, String leftButtonClickedImgPath, String rightButtonClickedImgPath) {
        ...
        leftButton = createImageButton(
                "/Image/Button/" + leftButtonImgPath,
                "/Image/Button/" + leftButtonClickedImgPath);

        rightButton = createImageButton(
                "/Image/Button/" + rightButtonImgPath,
                "/Image/Button/" + rightButtonClickedImgPath);
