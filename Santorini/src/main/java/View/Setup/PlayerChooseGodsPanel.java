...
public class PlayerChooseGodsPanel extends SetupPanel {

    private static final String textPath = "choose_a_god.png";

    private final List<String> godCardPaths;
    private final List<JButton> godCardButtons = new ArrayList<>(); // Store god card buttons

    public PlayerChooseGodsPanel(List<String> godCardPaths) {
